package com.taskify.todomanager.ui.home.util
...
fun categorizeTasks(tasks: List<TaskEntity>): Map<String, List<TaskEntity>> {
    ...
    return mapOf(
        "Pinned" to finalPinnedTasks,
        "Today" to todayTasks,
        "Tomorrow" to tomorrowTasks,
        "Upcoming" to upcomingTasks,
        "Overdue" to filteredOverdueTasks,
